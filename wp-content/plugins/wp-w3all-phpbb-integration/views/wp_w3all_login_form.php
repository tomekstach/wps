<?php defined( 'ABSPATH' ) or die( 'forbidden' ); 
  ...
  global $wp,$w3all_last_t_avatar_dim,$w3cookie_domain;
...
<form method="post" action="<?php echo $current_url; ?>" class="w3all_login_form">
	<h3><a href="<?php echo wp_registration_url(); ?>"><?php esc_html_e( 'Register' , 'wp-w3all-phpbb-integration' ); ?></a></h3>
			<input type="text" tabindex="1" name="w3all_username" id="username" size="10" class="" title="Username" /> <?php esc_html_e( 'Username' , 'wp-w3all-phpbb-integration' ); ?>
			<br /><br />
			<input type="password" tabindex="2" name="w3all_password" id="password" size="10" class="" title="Password" autocomplete="off" /> <?php esc_html_e( 'Password' , 'wp-w3all-phpbb-integration' ); ?>
			<br /><br />
