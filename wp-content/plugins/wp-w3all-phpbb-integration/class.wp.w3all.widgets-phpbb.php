...
?>
    ...
    <p>
      ...
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('display_phpbb_user_info'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="0" <?php if (0 == $display_phpbb_user_info) echo 'checked="checked"'; ?> /> <?php esc_html_e('No', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('display_phpbb_user_info'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="1" <?php if (1 == $display_phpbb_user_info) echo 'checked="checked"'; ?> /> <?php esc_html_e('Yes', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
...
class WP_w3all_widget_last_topics extends WP_Widget
{
  ...
  ?>
    ...
    <p>
      ...
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('post_text'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="0" <?php if (0 == $instance['post_text']) echo 'checked="checked"'; ?> /> <?php esc_html_e('No', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('post_text'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="1" <?php if (1 == $instance['post_text']) echo 'checked="checked"'; ?> /> <?php esc_html_e('Yes', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
    </p>
    <p>
...
class WP_w3all_widget_phpBB_mchat extends WP_Widget
{
  ...
  ?>
    ...
    <p>
      ...
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('display_mchat_only_logged'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="0" <?php if (0 == $display_mchat_only_logged) echo 'checked="checked"'; ?> /> <?php esc_html_e('No', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
      <p>
        <label""><input class="widefat" name="<?php echo $this->get_field_name('display_mchat_only_logged'); ?>" id="<?php echo $this->get_field_id('post_text'); ?>" type="radio" value="1" <?php if (1 == $display_mchat_only_logged) echo 'checked="checked"'; ?> /> <?php esc_html_e('Yes', 'wp-w3all-phpbb-integration'); ?></label>
      </p>
    </p>
<?php
  }
