    ...
    <fieldset>
      ...
      <div>
        ...
        <p>
          ...
          <input name="som_new_user_pass" id="som_new_user_pass"
            class="disblock som-password-input som-pass-strength-input" type="password"
            pattern=".{<?php echo $min_length; ?>,}" required>
          <?php } else { ?>
          <input name="som_new_user_pass" id="som_new_user_pass"
            class="disblock som-password-input som-pass-strength-input" type="password" required>
          <?php } ?>
        ...
        <p>
          ...
          <?php if (!empty($min_length)) { ?>
          <input name="som_new_user_pass_again" id="som_new_user_pass_again" class="disblock som-password-input"
            type="password" pattern=".{<?php echo $min_length; ?>,}" required>
          <?php } else { ?>
          <input name="som_new_user_pass_again" id="som_new_user_pass_again" class="disblock som-password-input"
